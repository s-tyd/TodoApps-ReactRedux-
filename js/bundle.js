...
var _sideArea = __webpack_require__(32);
...
var App = function (_React$Component) {
    ...
    _createClass(App, [{
        ...
        key: 'onDeleteGroup',
        value: function onDeleteGroup(id, groupName) {
            var _state = Object.assign({}, this.state);
            for (var i = 0; i < this.state.groupList.length; i++) {
                if (this.state.groupList[i].id == id) {
...
var _addGroupDialog = __webpack_require__(33);

var _addGroupDialog2 = _interopRequireDefault(_addGroupDialog);

var _editGroupDialog = __webpack_require__(34);
...
var SideArea = function (_React$Component) {
    ...
    _createClass(SideArea, [{
        ...
        key: 'onCancelEditGroupDialog',
        value: function onCancelEditGroupDialog() {
            this.setState({ showEditGroupDialog: false });
        }
    }, {
...
var AddGroupDialog = function (_React$Component) {
    ...
    function AddGroupDialog(props) {
        ...
        var _this = _possibleConstructorReturn(this, (AddGroupDialog.__proto__ || Object.getPrototypeOf(AddGroupDialog)).call(this, props));
...
function configureStore() {
    ...
    var store = (0, _redux.createStore)(_reducer2.default, (0, _redux.compose)(window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__(), (0, _redux.applyMiddleware)(logger)));
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(14), __webpack_require__(38)(module)))
